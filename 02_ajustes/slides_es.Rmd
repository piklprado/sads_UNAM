...
* Hay varios modelos para describir un conjunto de datos dado, 
...
El logaritmo de la función de verosimilitud, es decir, la **suma del logaritmo de las probabilidades** asignadas por un modelo
a cada observación de los datos <sup>2</sup> :
...
* Decimos que el modelo así ajustado es el que tiene el mayor apoyo de
  los datos, o que es el más plausible.
...
* Muchos de los métodos de ajuste de modelos estadísticos más conocidos
  ...
  mínimos cuadrados o ajustes de *glms* (métodos *iwls*).
...
* `sads` ajusta los modelos más usados por máxima verosimilitud con 3 funciones:
