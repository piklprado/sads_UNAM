...
* También propuso el primer modelo matemático para una SAD: una
  relación lineal entre el logaritmo de la abundancia ($y$) y el orden
...
$n$ individuos de una especie tomada al azar en la muestra es proporcional a: 
...
Encuentra en nuestro sitio los [tutoriales](https://piklprado.github.io/sads_UNAM/01_introduccion.html)

* **Gráficos** - *La línea de corte de Preston*

* **Modelos** - *De los parámetros a la forma de la SAD*
